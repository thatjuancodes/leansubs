import { Box, Container, Heading, Text, Button, Stack, Flex, SimpleGrid, Separator } from '@chakra-ui/react'
...
export function LandingPage() {
  ...
  return (
    <Box minH="100vh" display="flex" flexDirection="column">
      ...
      <Box bg="white" _dark={{ bg: "accent.900" }} flex="1">
      ...
      >
        <Container maxW="container.xl" mx="auto" px={{ base: 4, md: 8 }}>
          ...
          >
            ...
            >
              © 2025 PxL&Grain. All rights reserved.
            </Text>
          </Flex>
        </Container>
      </Box>
